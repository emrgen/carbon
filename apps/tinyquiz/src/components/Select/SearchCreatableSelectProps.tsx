...
interface SearchCreatableProps {
  isMulti?: boolean;
  visibleCount?: number;
...
export const SearchCreatableSelectProps = (props: SearchCreatableProps) => {
  const { visibleCount = 2, onChange, value, keys, onSearchKey, onSelectKey, values, onSearchValue} = props;
