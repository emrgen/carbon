...
//
// import {deepCloneMap, IDENTITY_SCOPE, NodeIdFactory, NodeFactory as CoreNodeFactory, Maps} from "@emrgen/carbon-core";
// import { isEmpty } from "lodash";
// import { v4 as uuidv4 } from 'uuid';
//
// let counter = 0;
//
// export class NodeFactory implements CoreNodeFactory {
// 	scope: Symbol;
//
// 	static blockId() {
...
// 	}
//
// 	create(json: any, schema: Schema, nodeIdFactory: NodeIdFactory = NodeFactory): Optional<Node> {
// 		const { scope } = this;
...
// 	clone(node: Node, map: Maps<Node, Node>): Node {
