...
export const InnerShowCurrentAngleHint =(props: ShowCurrentAngleHintProps, ref: React.Ref<HTMLDivElement>) => {
    const { isRotating } = props;

    const angleHint = useMemo(() => {
      return isRotating ? (
        <div ref={ref} className="de-transform--angle-hint" style={{
